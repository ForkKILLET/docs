import{_ as a,k as s,j as n,m as e}from"./chunks/framework.MHei6uDm.js";const m=JSON.parse('{"title":"公網部署","description":"","frontmatter":{},"headers":[],"relativePath":"zh-TW/manual/recipe/server.md","filePath":"zh-TW/manual/recipe/server.md"}'),p={name:"zh-TW/manual/recipe/server.md"},t=e(`<h1 id="公網部署" tabindex="-1">公網部署 <a class="header-anchor" href="#公網部署" aria-label="Permalink to &quot;公網部署&quot;">​</a></h1><div class="warning custom-block"><p class="custom-block-title">WARNING</p><p>將 Koishi 暴露在公網上可能會導致你的服務器受到攻擊。你需要妥善配合 <a href="./../usage/platform.html#控制台登录">用戶登錄</a> 等方式以限制控制臺功能的訪問能力。</p></div><p>Koishi 應用默認情況下只能在本機訪問。而對於某些需求，你可能希望在公網上訪問到 Koishi 的控制臺或其他網絡服務：</p><ul><li>讓更多人訪問到你的 Koishi 控制臺</li><li>使用作爲 webhook 服務端的插件 (例如 <a href="https://github.koishi.chat" target="_blank" rel="noreferrer">github</a>)</li></ul><p>本節教程將指導你完成 Koishi 應用的公網部署。</p><h2 id="直接暴露" tabindex="-1">直接暴露 <a class="header-anchor" href="#直接暴露" aria-label="Permalink to &quot;直接暴露&quot;">​</a></h2><p>點擊控制臺左側的「插件配置」，選擇「全局配置」并將 <code>host</code> 修改爲 <code>0.0.0.0</code>，隨後點擊右上角的「重載配置」。等待 Koishi 重啓之後，你就可以使用 <code>IP:端口</code> 的方式，在局域網内任意設備的瀏覽器上訪問到 Koishi 控制臺了。</p><p>如果你已經准備了域名，你還需要同時將 <code>selfUrl</code> 修改為能訪問到 Koishi 實例的地址。</p><h2 id="反向代理" tabindex="-1">反向代理 <a class="header-anchor" href="#反向代理" aria-label="Permalink to &quot;反向代理&quot;">​</a></h2><p>如果你有更复杂的需求，例如配置 SSL、域名等，可以使用反向代理。常见的方案有 nginx、Caddy 等。使用反向代理时，你不需要修改上述 <code>host</code> 配置项。</p><h3 id="使用-caddy" tabindex="-1">使用 Caddy <a class="header-anchor" href="#使用-caddy" aria-label="Permalink to &quot;使用 Caddy&quot;">​</a></h3><div class="language-text vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light one-dark-pro vp-code" tabindex="0"><code><span class="line"><span># 如果你希望使用域名，并自动签发 SSL 证书，请将下方 :80 改为你的域名</span></span>
